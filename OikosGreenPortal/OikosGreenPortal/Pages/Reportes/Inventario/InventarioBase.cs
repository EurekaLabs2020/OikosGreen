...
//            _datoPadre = 0;
//            _Mensaje = _datoTipo = "";
//            _regActual = new SaldoProducto_data();
...
//                    _lista = _dataRequest.entities.ToList();// .OrderBy(o => o.nombrefull).OrderByDescending(o => o.period).ToList();
...
//                //        _listaSecundaria = _dataRequestTercero.entities.ToList();//. OrderBy(o => o.nombrefull).ToList();
...
//        {
//            var item = ((Blazorise.DataGrid.CancellableRowChange<OikosGreenPortal.Data.Request.SaldoProducto_data, System.Collections.Generic.Dictionary<string, object>>)arg).Item;
//            var valor = ((Blazorise.DataGrid.CancellableRowChange<OikosGreenPortal.Data.Request.SaldoProducto_data, System.Collections.Generic.Dictionary<string, object>>)arg).Values;            
...
//            //SaldoProducto_data registro = item;
